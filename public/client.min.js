...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _uncut_gyro_components_Notification_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @uncut/gyro/components/Notification.js */ \"../gyro/components/Notification.js\");\n/* harmony import */ var _uncut_gyro_css_gyro_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @uncut/gyro/css/gyro.css */ \"../gyro/css/gyro.css\");\n/* harmony import */ var _uncut_gyro_layout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @uncut/gyro-layout */ \"../gyro-layout/index.js\");\n/* harmony import */ var _uncut_gyro_components_menu_bar_Menubar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @uncut/gyro/components/menu-bar/Menubar */ \"../gyro/components/menu-bar/Menubar.js\");\n/* harmony import */ var _uncut_gyro_components_Icon_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @uncut/gyro/components/Icon.js */ \"../gyro/components/Icon.js\");\n/* harmony import */ var _uncut_gyro_components_Knob_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @uncut/gyro/components/Knob.js */ \"../gyro/components/Knob.js\");\n/* harmony import */ var _uncut_gyro_components_FluidInput_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @uncut/gyro/components/FluidInput.js */ \"../gyro/components/FluidInput.js\");\n/* harmony import */ var _uncut_gyro_components_LevelSlider_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @uncut/gyro/components/LevelSlider.js */ \"../gyro/components/LevelSlider.js\");\n/* harmony import */ var _uncut_gyro_components_Input_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @uncut/gyro/components/Input.js */ \"../gyro/components/Input.js\");\n/* harmony import */ var _components_emote_editor_EmoteEditor_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/emote-editor/EmoteEditor.js */ \"./components/emote-editor/EmoteEditor.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nwindow.log = (...str) => {\r\n    new _uncut_gyro_components_Notification_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({ text: str.join(\" \"), time: 2000 }).show();\r\n    console.log(...str);\r\n}\r\n\r\nwindow.addEventListener('DOMContentLoaded', init());\r\n\r\nfunction updatePreviews(croppedImage) {\r\n\r\n    if(!croppedImage) return;\r\n\r\n    const canvases = document.querySelectorAll('.emote-preview');\r\n\r\n    for(let canvas of canvases) {\r\n        const context = canvas.getContext(\"2d\");\r\n        context.clearRect(0, 0, canvas.width, canvas.height);\r\n        context.drawImage(croppedImage, 0, 0, canvas.width, canvas.height);\r\n    }\r\n\r\n}\r\n\r\nwindow.addEventListener('dragover', e => {\r\n    e.preventDefault();\r\n});\r\n\r\nwindow.addEventListener('drop', e => {\r\n    if(e.dataTransfer.items) {\r\n        for(let item of e.dataTransfer.items) {\r\n            if (item.kind === 'file') {\r\n                const file = item.getAsFile();\r\n\r\n                const reader  = new FileReader();\r\n                reader.onload = function(e)  {\r\n                    const img = new Image();\r\n                    img.src = e.target.result;\r\n\r\n                    img.onload = () => {\r\n                        const editor = document.querySelector('gyro-emote-editor');\r\n                        editor.viewAsset({ data: img });\r\n\r\n                        updatePreviews(editor.getPreviewOutput());\r\n                    }\r\n                }\r\n                reader.readAsDataURL(file);\r\n            }\r\n        }\r\n    }\r\n})\r\n\r\nasync function init() {\r\n    const editor = document.querySelector('gyro-emote-editor');\r\n\r\n    editor.addEventListener('contextmenu', e => {\r\n        e.preventDefault();\r\n    });\r\n\r\n    editor.addEventListener('change', e => {\r\n        updatePreviews(editor.getPreviewOutput());\r\n    })\r\n\r\n    hideLoading();\r\n}\r\n\r\nfunction showLoading() {\r\n    document.body.setAttribute('loading', '');\r\n}\r\n\r\nfunction hideLoading() {\r\n    document.body.removeAttribute('loading');\r\n}\r\n\n\n//# sourceURL=webpack:///./src/client.mjs?");
